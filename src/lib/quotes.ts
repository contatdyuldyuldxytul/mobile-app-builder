...
export const QUOTES: Quote[] = [
  { text: "Ensina-nos a contar os nossos dias, para que alcancemos coração sábio.", author: "Salmo 90:12" },
  { text: "A maneira como você passa os seus dias é, no fim, a maneira como passa a sua vida.", author: "Annie Dillard" },
  ...
  { text: "Diga não a mil coisas boas para dizer sim às poucas essenciais.", author: "Greg McKeown" },
  ...
  { text: "Descansar não é preguiça; é a condição do trabalho que dura.", author: "John Mark Comer" },
  ...
  { text: "Faça uma coisa de cada vez, e faça-a como se nada mais existisse.", author: "Provérbio zen" },
  ...
  { text: "Grandes coisas não são feitas por impulso, mas por uma série de pequenas coisas reunidas.", author: "Vincent van Gogh" },
  ...
  { text: "Você nunca vai encontrar tempo para nada. Se quiser tempo, precisa criá-lo.", author: "Charles Buxton" },
  ...
  { text: "Ser ocupado é uma forma de preguiça: pensar sem discernimento e agir sem critério.", author: "Tim Ferriss" },
  ...
  { text: "Só se vê bem com o coração; o essencial é invisível aos olhos.", author: "Antoine de Saint-Exupéry" },
  { text: "Comece com o fim em mente.", author: "Stephen Covey" },
  { text: "A vida é longa se você souber usá-la.", author: "Sêneca" },
  { text: "Faça hoje o que outros não fazem, para viver amanhã como outros não vivem.", author: "Jerry Rice" },
  ...
  { text: "O melhor momento para plantar uma árvore foi há vinte anos. O segundo melhor é agora.", author: "Provérbio chinês" },
  ...
  { text: "Aprenda a dizer não; isso lhe será mais útil do que saber ler em latim.", author: "Charles Spurgeon" },
];

export const VERSES: Quote[] = [
  { text: "Ensina-nos a contar os nossos dias, para que alcancemos coração sábio.", author: "Salmo 90:12" },
  { text: "Entrega o teu caminho ao Senhor; confia nele, e ele tudo fará.", author: "Salmo 37:5" },
  { text: "Tudo tem o seu tempo determinado, e há tempo para todo propósito debaixo do céu.", author: "Eclesiastes 3:1" },
  { text: "Buscai primeiro o Reino de Deus, e todas essas coisas vos serão acrescentadas.", author: "Mateus 6:33" },
  ...
  { text: "Tudo o que fizerdes, fazei de todo o coração, como para o Senhor.", author: "Colossenses 3:23" },
  ...
  { text: "O coração do homem planeja o seu caminho, mas o Senhor lhe dirige os passos.", author: "Provérbios 16:9" },
  { text: "Não andeis ansiosos por coisa alguma.", author: "Filipenses 4:6" },
  { text: "Lâmpada para os meus pés é a tua palavra, e luz para o meu caminho.", author: "Salmo 119:105" },
  ...
  { text: "Este é o dia que o Senhor fez; regozijemo-nos e alegremo-nos nele.", author: "Salmo 118:24" },
  { text: "Os que esperam no Senhor renovam as suas forças.", author: "Isaías 40:31" },
  { text: "Em paz me deito e logo pego no sono, porque só tu, Senhor, me fazes repousar seguro.", author: "Salmo 4:8" },
  ...
  { text: "Confia no Senhor de todo o teu coração e não te apoies no teu próprio entendimento.", author: "Provérbios 3:5" },
];
